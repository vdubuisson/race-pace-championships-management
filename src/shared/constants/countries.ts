...
export const COUNTRIES: Country[] = [
  ...
  { iso2: 'VA', iso3: 'VAT', name: 'Holy See' },
  ...
  { iso2: 'SH', iso3: 'SHN', name: 'Tristan da Cunha' },
  ...
  { iso2: 'SJ', iso3: 'SJM', name: 'Jan Mayen' },
